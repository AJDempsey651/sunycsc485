...
def evaluate_strength_test(complexity):
    """Test that evaluate_strength will return false if passwords do not meet the strength threshold"""
    assert evaluate_strength(complexity) == False


@pytest.mark.parametrize('complexity', [50])
def evaluate_strength_test(complexity):
    """Test that evaluate_strength will return true is passwords meet the strength threshold"""
...
def test_complexity_0_strength(passwords):
    """Test that compute_complexity will return 0 if there are no complexifiers"""
...
def test_complexity_50_strength(passwords):
    """Test that compute_complexity will return 50.0 is there is an even number of
